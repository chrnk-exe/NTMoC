  ...
  return (
    <Box display={'flex'} flexDirection={'column'} justifyContent={'flex-start'} alignItems={'flex-start'}
        sx={{width: 1}} fontSize={17} gap={0.5}>
            ...
            <OutlinedFormula
                description={'Для вычисления первообразного корня по модулю необходимо найти число q, отвечающее показателю, равному значению функции Эйлера от этого модуля'}
